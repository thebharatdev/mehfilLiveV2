    ...
    <main className="mehfil-container" style={{ padding: '2rem 0 4rem' }}>
      ...
      <div className="featured-poet fade-up" style={{
        ...
        <div style={{ flex: 1, minWidth: '200px' }}>
          ...
          <h2 style={{ fontFamily: "'Noto Serif Devanagari', 'Playfair Display', 'Cormorant Garamond', serif", fontWeight: 700, fontSize: '2.1rem', color: 'var(--accent-dark)', letterSpacing: '0.2px', lineHeight: 1.3 }}>
            मन्नत काज़मी
          </h2>
      ...
      <div className="filter-bar fade-up" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#fef9f2', padding: '0.4rem 1.2rem', borderRadius: 50, border: '1px solid var(--border-light)', minWidth: 220 }}>
          ...
          <input
            ...
            style={{ border: 'none', background: 'transparent', outline: 'none', flex: 1, fontFamily: 'inherit', fontSize: '0.88rem' }}
          />
          {search && (
            <button
              type="button"
      ...
      {filtered.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '3.5rem 1rem', color: 'var(--text-muted)' }}>
          <i className="fas fa-user-slash" style={{ fontSize: '2.5rem', opacity: 0.35, marginBottom: '0.8rem', display: 'block' }} />
          <p style={{ fontSize: '1.1rem', marginBottom: '0.5rem' }}>कोई रचनाकार नहीं मिला</p>
          {search && (
            <button
              className="secondary-btn"
              style={{ marginTop: '0.5rem', fontSize: '0.85rem' }}
              onClick={() => { setSearch(''); setStyle('all'); }}
            >
              खोज फ़िल्टर हटाएँ
            </button>
          )}
        ...
        <div className="poets-grid">
          {filtered.map((writer) => (
            <Link
              ...
              key={writer._id}
              className="writer-card-premium poet-card"
              style={{
                background: 'white',
                borderRadius: '2rem',
            ...
            >
              ...
              <div className="poet-card-info">
                ...
                <h3 className="poet-card-name" style={{ fontFamily: "'Noto Serif Devanagari', 'Playfair Display', 'Cormorant Garamond', serif", fontWeight: 700, fontSize: 'clamp(1.2rem, 2vw, 1.55rem)', margin: '0.5rem 0', color: 'var(--accent-dark)', letterSpacing: '0.2px', lineHeight: 1.35 }}>
